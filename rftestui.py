...
class Ui_rftestui(object):
    def setupUi(self, rftestui):
        ...
        self.buttonStartSimpleTest = QtGui.QPushButton(rftestui)
        self.buttonStartSimpleTest.setGeometry(QtCore.QRect(640, 80, 72, 22))
        font = QtGui.QFont()
        font.setPointSize(7)
        self.buttonStartSimpleTest.setFont(font)
        self.buttonStartSimpleTest.setObjectName(_fromUtf8("buttonStartSimpleTest"))
        self.buttonStartRfTest = QtGui.QPushButton(rftestui)
        self.buttonStartRfTest.setGeometry(QtCore.QRect(640, 240, 72, 22))
        font = QtGui.QFont()
        font.setPointSize(7)
        self.buttonStartRfTest.setFont(font)
        self.buttonStartRfTest.setObjectName(_fromUtf8("buttonStartRfTest"))
        self.buttonStartPowerLevelTest = QtGui.QPushButton(rftestui)
        self.buttonStartPowerLevelTest.setGeometry(QtCore.QRect(640, 360, 72, 22))
        font = QtGui.QFont()
        font.setPointSize(7)
        self.buttonStartPowerLevelTest.setFont(font)
        self.buttonStartPowerLevelTest.setObjectName(_fromUtf8("buttonStartPowerLevelTest"))
    ...
    def retranslateUi(self, rftestui):
        ...
        self.buttonStartSimpleTest.setText(_translate("rftestui", "Start", None))
        self.buttonStartRfTest.setText(_translate("rftestui", "Start", None))
        self.buttonStartPowerLevelTest.setText(_translate("rftestui", "Start", None))
