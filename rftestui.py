...
class Ui_rftestui(object):
    def setupUi(self, rftestui):
        ...
        self.hdmiOutResult.setAutoFillBackground(True)
        self.hdmiOutResult.setText(_fromUtf8(""))
        self.hdmiOutResult.setScaledContents(False)
        self.hdmiOutResult.setWordWrap(True)
        self.hdmiOutResult.setIndent(0)
